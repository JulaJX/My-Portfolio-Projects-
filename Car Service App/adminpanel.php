...
<div class="account-title2">
    ...
    <h1 class="account-main-h1">Rezerwacje użytkowników</h1>  
</div>
...
try
               ...
               {   
                   ...
                   echo( 
                    ...
                    <div class="account-reserve-box">
                        ...
                        <p class="account-res">Rezerwacja na termin:<span class="colorp"> '.$fetching['scheduledate'].'</span></p>
                        <p class="account-res">Imię i Nazwisko:<span class="colorp"> '.$fetching['fullname'].' '.$fetching['surname'].'</span></p>
                        <p class="account-res">E-mail:<span class="colorp"> '.$fetching['email'].'</span></p>
                        <p class="account-res">Telefon:<span class="colorp"> '.$fetching['phone'].'</span></p>
                        <p class="account-res">Wiadomość:<span class="colorp"> '.$fetching['message'].'</span></p>
                        <a href="delete.php?id='.$fetching['scheduledate'].'">
                        <input type="submit" value="Usuń rezerwacje" class="deletebtn1">
                        </a>
                    </div>
                    '
                   );
       ...
       if($total<1){
           echo '<p class="nores-p">Brak rezerwacji</p>';
       }
